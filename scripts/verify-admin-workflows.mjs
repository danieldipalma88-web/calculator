...
const checks = [
  ...
  [adminPage.includes('data-won-payment-filter'), "mutually exclusive Won Quotes payment filters"],
  [adminPage.includes('var payment = activePayments[0] || "all";'), "single active Won Quotes payment filter"],
  [adminPage.includes('data-won-mobile-summary'), "filtered totals summary"],
  ...
  [styles.includes(".won-filtered-totals"), "Won Quotes totals styling"],
  [styles.includes(".won-payment-filters"), "Won Quotes payment filter styling"],
